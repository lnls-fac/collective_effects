...
def convolution_full_orig(*args):
  return _cppcolleff.convolution_full_orig(*args)
...
def convolution_same_orig(*args):
  return _cppcolleff.convolution_same_orig(*args)
...
class Bunch_t(_object):
    ...
    __del__ = lambda self : None;
    def get_xx(self): return _cppcolleff.Bunch_t_get_xx(self)
    def get_xl(self): return _cppcolleff.Bunch_t_get_xl(self)
    def get_de(self): return _cppcolleff.Bunch_t_get_de(self)
    def get_ss(self): return _cppcolleff.Bunch_t_get_ss(self)
...
class Ring_t(_object):
    ...
    def get_integrated_distribution(self, *args): return _cppcolleff.Ring_t_get_integrated_distribution(self, *args)
...
class WakePl(_object):
    ...
    if _newclass:wake_function = _swig_property(_cppcolleff.WakePl_wake_function_get, _cppcolleff.WakePl_wake_function_set)
    ...
    if _newclass:wake_potential = _swig_property(_cppcolleff.WakePl_wake_potential_get, _cppcolleff.WakePl_wake_potential_set)
    ...
    if _newclass:WF = _swig_property(_cppcolleff.WakePl_WF_get, _cppcolleff.WakePl_WF_set)
    __swig_setmethods__["WP"] = _cppcolleff.WakePl_WP_set
    __swig_getmethods__["WP"] = _cppcolleff.WakePl_WP_get
    if _newclass:WP = _swig_property(_cppcolleff.WakePl_WP_get, _cppcolleff.WakePl_WP_set)
