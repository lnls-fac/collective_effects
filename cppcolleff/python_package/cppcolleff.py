...
class Bunch_t(_object):
    ...
    __swig_setmethods__["de"] = _cppcolleff.Bunch_t_de_set
    __swig_getmethods__["de"] = _cppcolleff.Bunch_t_de_get
    if _newclass:de = _swig_property(_cppcolleff.Bunch_t_de_get, _cppcolleff.Bunch_t_de_set)
    __swig_setmethods__["xx"] = _cppcolleff.Bunch_t_xx_set
    __swig_getmethods__["xx"] = _cppcolleff.Bunch_t_xx_get
    if _newclass:xx = _swig_property(_cppcolleff.Bunch_t_xx_get, _cppcolleff.Bunch_t_xx_set)
    __swig_setmethods__["xl"] = _cppcolleff.Bunch_t_xl_set
    __swig_getmethods__["xl"] = _cppcolleff.Bunch_t_xl_get
    if _newclass:xl = _swig_property(_cppcolleff.Bunch_t_xl_get, _cppcolleff.Bunch_t_xl_set)
    __swig_setmethods__["ss"] = _cppcolleff.Bunch_t_ss_set
    __swig_getmethods__["ss"] = _cppcolleff.Bunch_t_ss_get
    if _newclass:ss = _swig_property(_cppcolleff.Bunch_t_ss_get, _cppcolleff.Bunch_t_ss_set)
    def __init__(self, *args): 
        this = _cppcolleff.new_Bunch_t(*args)
        try: self.this.append(this)
        except: self.this = this
    def InsertionSort(self): return _cppcolleff.Bunch_t_InsertionSort(self)
