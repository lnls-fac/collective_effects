...
def create_ring(phase=2):
    ...
    if phase == 0: #commissioning
        ...
        ring.sigma       = lambda x:    (2.45e-3 + 5.80e-4*x - 1.51e-4*x**2 + 3.45e-5*x**3 - 3.15e-6*x**4)
        ring.emitx       = lambda x:1e-9*(2.44e-1+ 1.57e-1*x - 6.36e-2*x**2 + 1.60e-2*x**3 - 1.55e-3*x**4)
