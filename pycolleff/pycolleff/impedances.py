...
def calc_alphas(k, gamma, beta, *args, is_in_t=True):
    ...
    for i, kovgi in enumerate(kovgamma):
        ...
        print(
            f'{i:04d}/{len(k):04d} -> '
            f'freq = {k[i]*beta*_c/2/_np.pi:8.2g} Hz,   '
...
def from_impedance_to_wake(
    ...
    # I neet to take the conjugate of the impedance here, because the convention adopted
    # by ref[1] is different than the one we consider here.
