...
def create_ring():
    """Create ALS-U collective effects model ring based on data provided in [1, 2].

    Returns:
        ring (pycolleff.colleff.Ring): main parameters for collective effects

    References:
    [1] Warnock, R. (2021). Equilibrium of an arbitrary bunch train with cavity resonators and short range wake: Enhanced iterative solution with Anderson acceleration. Physical Review Accelerators and Beams, 24 (10), 104402. https://doi.org/10.1103/physrevaccelbeams.24.104402

    [2] Warnock, R. (2021). Equilibrium of an arbitrary bunch train in the presence of multiple resonator wakefields. Physical Review Accelerators and Beams, 24 (2), 1–27. https://doi.org/10.1103/PhysRevAccelBeams.24.024401
    """
    ring = _Ring()
    ring.version = 'ALS-U'
